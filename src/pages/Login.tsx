...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (email === 'Saleem' && password === 'eco123eco123') {
      onLogin();
    } else {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center items-center py-12 sm:px-6 lg:px-8 bg-gray-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        {/* Logo Placeholder */}
        <div className="mx-auto h-12 w-auto text-blue-600 text-4xl font-bold">
        <svg width="200" height="60" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg">
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle"
        fill="#2563eb" font-size="36" font-weight="bold" font-family="sans-serif">
    Globbly
  </text>
</svg>
        </div>
